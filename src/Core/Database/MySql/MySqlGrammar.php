...
namespace UnderScorer\Core\Database\MySql;
...
class MySqlGrammar extends Grammar
{
     ...
     * @return string
     */
    protected function compileCreateTable( $blueprint, $command, $ConnectionInterface )
    {
    ...
    protected function compileCreateEncoding( $sql, ConnectionInterface $connection, Blueprint $blueprint )
    {
        ...
        // blueprint itself or on the root configuration for the ConnectionInterface that the
        ...
        // ConnectionInterface that the query is targeting. We'll add it to this SQL query.
